...
/*********************/
var valueMinWidth = 4;
var valueMinHeight = 2;
var expectec StretchCell = ["


describe "StretchCell", function(){
  it("Creation of StretchCells", function(){
	var stretchCell = new StretchCell("hola",1,2);

	assert(stretchCell.minWidth() == valueMinWidth);
	assert(stretchCell.minHeight() == valueMinHeight);
